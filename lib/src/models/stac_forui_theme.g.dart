...
StacForuiTheme _$StacForuiThemeFromJson(Map<String, dynamic> json) =>
    StacForuiTheme(
      ...
      style: json['style'] == null
          ? null
          : StacForuiStyle.fromJson(json['style'] as Map<String, dynamic>),
    );
...
StacForuiStyle _$StacForuiStyleFromJson(Map<String, dynamic> json) =>
    StacForuiStyle(
      borderRadius: (json['borderRadius'] as num?)?.toDouble(),
      borderWidth: (json['borderWidth'] as num?)?.toDouble(),
      touch: json['touch'] as bool? ?? true,
    );

Map<String, dynamic> _$StacForuiStyleToJson(StacForuiStyle instance) =>
    <String, dynamic>{
...
StacForuiTypography _$StacForuiTypographyFromJson(Map<String, dynamic> json) =>
    StacForuiTypography(
      ...
      touch: json['touch'] as bool? ?? true,
      xs3: json['xs3'] as Map<String, dynamic>?,
      xs2: json['xs2'] as Map<String, dynamic>?,
      xs: json['xs'] as Map<String, dynamic>?,
      sm: json['sm'] as Map<String, dynamic>?,
      md: json['md'] as Map<String, dynamic>?,
      lg: json['lg'] as Map<String, dynamic>?,
      xl: json['xl'] as Map<String, dynamic>?,
      xl2: json['xl2'] as Map<String, dynamic>?,
      xl3: json['xl3'] as Map<String, dynamic>?,
      xl4: json['xl4'] as Map<String, dynamic>?,
      xl5: json['xl5'] as Map<String, dynamic>?,
      xl6: json['xl6'] as Map<String, dynamic>?,
      xl7: json['xl7'] as Map<String, dynamic>?,
      xl8: json['xl8'] as Map<String, dynamic>?,
    );
