...
FLineCalendar({
  ...
  Widget Function(
        ...
        ({
          ...
          Set<FLineCalendarItemVariant> variants,
        }),
        Widget?,
      )
      builder =
...
FButton.icon({
  ...
  Map<ShortcutActivator, Intent>? shortcuts,
  Map<Type, Action<Intent>>? actions,
  Widget Function(BuildContext, FButtonStyle, IconThemeData, Widget?)
      builder =
      defaultIconContentBuilder,
  Widget? child,
  Key? key,
})
...
```dart
class LeadingLabelCheckboxExample extends StatefulWidget {
  @override
  State<LeadingLabelCheckboxExample> createState() =>
      _LeadingLabelCheckboxExampleState();
}

class _LeadingLabelCheckboxExampleState
    extends State<LeadingLabelCheckboxExample> {
  bool _state = false;
...
FDateField.calendar({
  ...
  FTextFieldSizeVariant size,
  FDateFieldStyleDelta style,
  String Function(BuildContext, DateTime, DateFormat) format,
  TextAlign textAlign,
  TextAlignVertical? textAlignVertical,
  TextDirection? textDirection,
  bool expands,
...
@override
Widget build(BuildContext context) =>
    FDateTimePicker(control: .managed(initial: .now()));
...
```dart
FDateTimePicker({
  FDateTimePickerControl control = const .managed(),
  FDateTimePickerStyleDelta style = const .context(),
  bool hour24 = false,
  int dayInterval = 1,
  int hourInterval = 1,
  int minuteInterval = 1,
  Widget Function(BuildContext, DateTime, DateFormat) dateBuilder =
      defaultDateBuilder,
  Key? key,
})
...
FOtpField({
  ...
  DragStartBehavior dragStartBehavior = .start,
  MouseCursor? mouseCursor,
  Iterable<String>? autofillHints = const [AutofillHints.oneTimeCode],
  String? restorationId,
  bool stylusHandwritingEnabled = true,
  bool enableIMEPersonalizedLearning = true,
  ContentInsertionConfiguration? contentInsertionConfiguration,
...
```dart
class LeadingLabelRadioExample extends StatefulWidget {
  @override
  State<LeadingLabelRadioExample> createState() =>
      _LeadingLabelRadioExampleState();
}

class _LeadingLabelRadioExampleState extends State<LeadingLabelRadioExample> {
  bool _value = true;
...
```dart
class LeadingLabelSwitchExample extends StatefulWidget {
  @override
  State<LeadingLabelSwitchExample> createState() =>
      _LeadingLabelSwitchExampleState();
}

class _LeadingLabelSwitchExampleState extends State<LeadingLabelSwitchExample> {
  bool _state = false;
...
FTimeField.picker({
  ...
  FTimeFieldStyleDelta style,
  bool hour24,
  String Function(BuildContext, FTime, DateFormat) format,
  TextAlign textAlign,
  TextAlignVertical? textAlignVertical,
  TextDirection? textDirection,
  bool expands,
...
> **Info:** This widget is typically used to create other high-level widgets. For higher-level positioning with anchor alignment
> and overflow handling, use [FPortal](../foundation/portal).

```dart
class OverlayExample extends StatefulWidget {
  @override
  State<OverlayExample> createState() => _State();
}

class _State extends State<OverlayExample> {
  @override
  Widget build(BuildContext context) => FOverlay(
    overlay: [
      Positioned(
        top: -50,
        left: 0,
...
FTabs({
  ...
  ScrollPhysics? physics,
  ScrollPhysics contentPhysics = const BouncingScrollPhysics(),
...
> **Info:** Hold `Shift` while scrolling to swipe between tabs on desktop and web.
