...
relates_to:
  - zeroflat_initial_proposal.json (this folder)
  - ../stac-forui-components_plan.md (current STAC integration plan)
  - ../audits/assessment.md (audit of the current repo)
  - ../flatbuffers_strategy.md (yesterday's analysis of fbs+STAC; superseded for the in-process case)
upstream_deps:
